...
Major Architecture Phase D2 is complete. The repository now includes the package
...
envelope, gated Alpaca live adapter construction, a dependency-free IBKR paper
brokerage foundation, operational runbooks, and tests.
...
D3 for automated live decision submission.
...
tests/            Smoke, unit, and integration tests through Phase D2
